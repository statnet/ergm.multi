#  File tests/testthat/test-term-dgwesp-ml.R in package ergm.multi, part of the
...
test_that(mkdesc("homogeneously directed", decay, sptxt), {
  ...
  stats <- sapply(sim,
                  function(nw){
                    m <- unLayer(nw) |> lapply(as.matrix)

                    c(
                      # despL distinct layers
                      despL(0:n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      despL(0:n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      despL(0:n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      despL(0:n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      despL(0:n,OSP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      despL(0:n,ISP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # ddspL distinct layers
                      ddspL(0:n,OTP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ddspL(0:n,ITP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ddspL(0:n,OTP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      ddspL(0:n,ITP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      ddspL(0:n,OSP,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      ddspL(0:n,ISP,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # dnspL distinct layers
                      dnspL(0:n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dnspL(0:n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dnspL(0:n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dnspL(0:n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dnspL(0:n,OSP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      dnspL(0:n,ISP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # despL base and path distinct
                      despL(0:n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      despL(0:n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      despL(0:n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      despL(0:n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      despL(0:n,OSP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      despL(0:n,ISP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # ddspL base and path distinct
                      ddspL(0:n,OTP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ddspL(0:n,ITP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ddspL(0:n,OTP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ddspL(0:n,ITP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ddspL(0:n,OSP,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ddspL(0:n,ISP,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # dnspL base and path distinct
                      dnspL(0:n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      dnspL(0:n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      dnspL(0:n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      dnspL(0:n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      dnspL(0:n,OSP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      dnspL(0:n,ISP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # despL base and path same
                      despL(0:n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      despL(0:n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      despL(0:n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      despL(0:n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      despL(0:n,OSP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      despL(0:n,ISP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # ddspL base and path same
                      ddspL(0:n,OTP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ddspL(0:n,ITP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ddspL(0:n,OTP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ...
                      ddspL(0:n,ISP,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # dnspL base and path same
                      dnspL(0:n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      dnspL(0:n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      dnspL(0:n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      dnspL(0:n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      dnspL(0:n,OSP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      dnspL(0:n,ISP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # despL distinct base and one layer
                      despL(0:n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      despL(0:n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      despL(0:n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      despL(0:n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      despL(0:n,OSP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      despL(0:n,ISP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # ddspL distinct base and one layer
                      ddspL(0:n,OTP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ddspL(0:n,ITP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ddspL(0:n,OTP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      ...
                      ddspL(0:n,ISP,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # dnspL distinct base and one layer
                      dnspL(0:n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dnspL(0:n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dnspL(0:n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dnspL(0:n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dnspL(0:n,OSP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      dnspL(0:n,ISP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # Geometrically weighted
                      # despL distinct layers
                      dgwespL(decay,n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dgwespL(decay,n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dgwespL(decay,n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dgwespL(decay,n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dgwespL(decay,n,OSP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      dgwespL(decay,n,ISP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # ddspL distinct layers
                      dgwdspL(decay,n,OTP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dgwdspL(decay,n,ITP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dgwdspL(decay,n,OTP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dgwdspL(decay,n,ITP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dgwdspL(decay,n,OSP,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      dgwdspL(decay,n,ISP,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # dnspL distinct layers
                      dgwnspL(decay,n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dgwnspL(decay,n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      dgwnspL(decay,n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dgwnspL(decay,n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      dgwnspL(decay,n,OSP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      dgwnspL(decay,n,ISP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]])## ,
                      ## # despL base and path distinct
                      ## dgwespL(decay,n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwespL(decay,n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwespL(decay,n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwespL(decay,n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwespL(decay,n,OSP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## dgwespL(decay,n,ISP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # ddspL base and path distinct
                      ## dgwdspL(decay,n,OTP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwdspL(decay,n,ITP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwdspL(decay,n,OTP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwdspL(decay,n,ITP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwdspL(decay,n,OSP,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## dgwdspL(decay,n,ISP,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # dnspL base and path distinct
                      ## dgwnspL(decay,n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwnspL(decay,n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwnspL(decay,n,OTP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwnspL(decay,n,ITP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwnspL(decay,n,OSP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## dgwnspL(decay,n,ISP,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # despL base and path same
                      ## dgwespL(decay,n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwespL(decay,n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwespL(decay,n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwespL(decay,n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwespL(decay,n,OSP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## dgwespL(decay,n,ISP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # ddspL base and path same
                      ## dgwdspL(decay,n,OTP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwdspL(decay,n,ITP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwdspL(decay,n,OTP,Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ...
                      ## dgwdspL(decay,n,ISP,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # dnspL base and path same
                      ## dgwnspL(decay,n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwnspL(decay,n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=TRUE),
                      ## dgwnspL(decay,n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwnspL(decay,n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]], in.order=FALSE),
                      ## dgwnspL(decay,n,OSP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## dgwnspL(decay,n,ISP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # despL distinct base and one layer
                      ## dgwespL(decay,n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ## dgwespL(decay,n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ## dgwespL(decay,n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      ## dgwespL(decay,n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      ## dgwespL(decay,n,OSP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      ## dgwespL(decay,n,ISP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      ## # ddspL distinct base and one layer
                      ## dgwdspL(decay,n,OTP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ## dgwdspL(decay,n,ITP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ## dgwdspL(decay,n,OTP,Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      ...
                      ## dgwdspL(decay,n,ISP,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      ## # dnspL distinct base and one layer
                      ## dgwnspL(decay,n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ## dgwnspL(decay,n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=TRUE),
                      ## dgwnspL(decay,n,OTP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      ## dgwnspL(decay,n,ITP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]], in.order=FALSE),
                      ## dgwnspL(decay,n,OSP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      ## dgwnspL(decay,n,ISP,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]])
                    )
                  }) %>% t()
  ...
  stats <- sapply(sim,
                  function(nw){
                    ...
                    c(
                      ...
                      espL(0:n,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # dspL distinct layers
                      dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # nspL distinct layers
                      nspL(0:n,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # espL base and path distinct
                      espL(0:n,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # dspL base and path distinct
                      dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # nspL base and path distinct
                      nspL(0:n,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # espL base and path same
                      espL(0:n,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # dspL base and path same
                      dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # nspL base and path same
                      nspL(0:n,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # espL distinct base and one layer
                      espL(0:n,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # dspL distinct base and one layer
                      dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # nspL distinct base and one layer
                      nspL(0:n,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # Geometrically weighted
                      # espL distinct layers
                      gwespL(decay,n,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # dspL distinct layers
                      gwdspL(decay,n,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # nspL distinct layers
                      gwnspL(decay,n,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[3]])## ,
                      ## # espL base and path distinct
                      ## gwespL(decay,n,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # dspL base and path distinct
                      ## gwdspL(decay,n,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # nspL base and path distinct
                      ## gwnspL(decay,n,L.base=m[[1]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # espL base and path same
                      ## gwespL(decay,n,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # dspL base and path same
                      ## gwdspL(decay,n,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # nspL base and path same
                      ## gwnspL(decay,n,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      ## # espL distinct base and one layer
                      ## gwespL(decay,n,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      ## # dspL distinct base and one layer
                      ## gwdspL(decay,n,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      ## # nspL distinct base and one layer
                      ## gwnspL(decay,n,L.base=m[[2]],Ls.path1=m[[2]],Ls.path2=m[[3]])
                    )
                  }) %>% t()
  ...
  stats <- sapply(sim,
                  function(nw){
                    ...
                    c(
                      ## b1
                      # dspL distinct layers
                      b1dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # dspL base and path distinct
                      b1dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # dspL base and path same
                      b1dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # dspL distinct base and one layer
                      b1dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # Geometrically weighted
                      # dspL distinct layers
                      gwb1dspL(decay,n,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      ## b2
                      # dspL distinct layers
                      b2dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # dspL base and path distinct
                      b2dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # dspL base and path same
                      b2dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[2]]),
                      # dspL distinct base and one layer
                      b2dspL(0:n,Ls.path1=m[[2]],Ls.path2=m[[3]]),
                      # Geometrically weighted
                      # dspL distinct layers
                      gwb2dspL(decay,n,Ls.path1=m[[2]],Ls.path2=m[[3]])
                    )
                  }) %>% t()
